...
namespace Kart_Rank_Test
{
    ...
    {
        [TestMethod]
        public void Validate_GetRankTime_ByGetRecords()
        {
            // Arrange
        ...
        [TestMethod]
        public void Not_Validate_GetRankTime_ByGetRecords()
        {
            // Arrange
        ...
        [TestMethod]
        public void Get_Add_The_Lap_Times_ByGetRecords()
        {
            //arrange:
        ...
        [TestMethod]
        public void Not_Returns_Data_From_Competitors_ByGetRecords()
        {
            //arrange:
            var GetRankTime = KartLogRepository.NullKartLogInMemoryRepository();
            //act:
